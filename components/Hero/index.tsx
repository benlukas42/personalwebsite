...
const Hero = () => {
  return (
    <>
      <section
        id="home"
        className="dark:bg-dark relative z-10 overflow-hidden bg-white pb-16 pt-[120px] md:pb-[120px] md:pt-[150px] xl:pb-[160px] xl:pt-[180px] 2xl:pb-[200px] 2xl:pt-[210px]"
      >
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-1/2 px-4 sm:w-full md:w-full lg:w-1/2">
              <div
